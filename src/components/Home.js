...
export const Home=()=>{
    let headImg = Helper.getMODI(require('./assets/eszt.jpg'),require('./assets/eszt_mobile.jpg'));
    let otherImg = Helper.getMODI(require('./assets/eszt2.jpg'),require('./assets/eszt2_mobile.jpg'));
    ...
    return(
        <div>
            ...
            <div className={'panorama-container-container'}>
                <SphereView id="1" image={require('./assets/pano1.jpg')} />
                <SphereView id="2" image={require('./assets/pano2.jpg')} />
            </div>
