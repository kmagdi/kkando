...
export const Home=()=>{
    ...
    const images = {
        ...
        szakmaszerkezet: require('./assets/szakmaszerkezet.jpg'),
        makerspace: require('./assets/makerspace.jpg')
    };
